...
def drawshit():
 ...
 {y}Автоматическое создание аккаунтов в Spotify 
          github.com/KaliSecurityMax{re}   
    ''')
...
def mainfunction():
    ...
    if x == "y":
        while True:
            ...
            password = random_char(5)+"kalimax-1234"
            ...
            print(f"[{g}KaliSecurityMax{y} SpotifyGenerator{re}] " + Email + ":" + password + " (Создано)")
            hits = open("accounts.txt","a")
            hits.write(Email + ":" + password + " | github.com/KaliSecurityMax" + "\n")
            hits.close
